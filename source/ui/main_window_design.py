...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/resources/icons/wiki.svg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.WikiButton.setIcon(icon1)
        self.WikiButton.setIconSize(QtCore.QSize(32, 32))
        self.WikiButton.setObjectName("WikiButton")
        self.HeaderLayout.addWidget(self.WikiButton)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/resources/icons/minimize.svg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/resources/icons/close.svg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        self.LibraryStablePage.setGeometry(QtCore.QRect(0, 0, 632, 267))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/resources/icons/page_opened.svg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.LibraryToolBox.addItem(self.LibraryStablePage, icon4, "")
        self.LibraryDailyPage = QtWidgets.QWidget()
        self.LibraryDailyPage.setGeometry(QtCore.QRect(0, 0, 632, 267))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/resources/icons/page_closed.svg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.LibraryToolBox.addItem(self.LibraryDailyPage, icon5, "")
        self.LibraryExperimentalPage = QtWidgets.QWidget()
        self.LibraryExperimentalPage.setGeometry(QtCore.QRect(0, 0, 632, 267))
        ...
        self.LibraryToolBox.addItem(self.LibraryExperimentalPage, icon5, "")
        self.LibraryCustomPage = QtWidgets.QWidget()
        self.LibraryCustomPage.setObjectName("LibraryCustomPage")
        self.verticalLayout_10 = QtWidgets.QVBoxLayout(self.LibraryCustomPage)
        self.verticalLayout_10.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_10.setObjectName("verticalLayout_10")
        self.LibraryCustomListWidget = QtWidgets.QListWidget(self.LibraryCustomPage)
        self.LibraryCustomListWidget.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.LibraryCustomListWidget.setObjectName("LibraryCustomListWidget")
        self.verticalLayout_10.addWidget(self.LibraryCustomListWidget)
        self.LibraryToolBox.addItem(self.LibraryCustomPage, icon5, "")
        ...
        self.DownloadsStablePage.setGeometry(QtCore.QRect(0, 0, 632, 291))
        ...
        self.DownloadsToolBox.addItem(self.DownloadsStablePage, icon4, "")
        ...
        self.DownloadsToolBox.addItem(self.DownloadsDailyPage, icon5, "")
        ...
        self.DownloadsToolBox.addItem(self.DownloadsExperimentalPage, icon5, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.LibraryCustomListWidget.setSortingEnabled(True)
        self.LibraryToolBox.setItemText(self.LibraryToolBox.indexOf(self.LibraryCustomPage), _translate("MainWindow", "Custom Builds"))
        self.TabWidget.setTabText(self.TabWidget.indexOf(self.LibraryTab), _translate("MainWindow", "Library"))
        self.DownloadsStableListWidget.setSortingEnabled(True)
        ...
        self.DownloadsDailyListWidget.setSortingEnabled(True)
        ...
        self.DownloadsExperimentalListWidget.setSortingEnabled(True)
